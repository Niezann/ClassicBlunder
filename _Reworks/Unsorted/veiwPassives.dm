...
"Soulfire"= "decreases target's mana and capacity dependent on passive level, also increases their fatigue",
...
"Underdog"= "gives you increased damage and damage reduction based on how many wounds you have (increased ratio for humans and KoBs)",
